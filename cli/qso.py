...
def main(argv=None):
    ...
    ap.add_argument("--call", required=True, help="Their callsign")
    ...
    ap.add_argument("--rst-s", default="599", help="RST sent (default: 599)")
    ap.add_argument("--rst-r", default="599", help="RST received (default: 599)")
    ap.add_argument("--station", dest="station_callsign", help="Your station callsign")
    ap.add_argument("--op", dest="operator", help="Operator callsign")
    ap.add_argument("--pwr", type=float, dest="tx_pwr_w", help="Power in watts")
    ap.add_argument("--skcc", dest="their_skcc", help="Their SKCC number (e.g. 22224T)")
    ap.add_argument("--my-skcc", dest="my_skcc", help="Your SKCC number (optional)")
