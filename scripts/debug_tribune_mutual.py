...
def analyze_tribune_mutual_progress(adif_files, members):
    ...
    for timestamp, q in valid_qsos:
            ...
            if member.join_date and timestamp < member.join_date:
                ...
                if other_qualifies and you_qualify:
                    if numeric_id not in tribune_qualified:
                        ...
                        result = f"★ TRIBUNE QUALIFIED (Other:{status_at_qso}, You:{your_status_at_qso})"
                    else:
        ...
        print(f"{date_str} {time_str}  {q.call:<10} {skcc_str} {status_at_qso or '':<10} {your_status_at_qso or '':<10} {member_num:<8} {result}")
...
def get_your_status_at_qso_time(your_member, qso_timestamp):
    ...
    centurion_achievement_date = datetime(2025, 6, 1)  # Adjust this based on when you think you achieved it
