...
class SKCCClusterClient:
    ...
    def __init__(self, callsign: str, spot_callback: Optional[Callable[[ClusterSpot], None]] = None):
    ...
    def _process_line(self, line: str):
        ...
        if match:
            ...
            if any(keyword in line.lower() for keyword in ['login', 'welcome', 'connected', 'filter']):
